	...
	<div style="padding: 20px;">
		...
		<div>
			...
			<el-row type='flex' justify='end'>
				<el-pagination @size-change='handlePageSizeChange' @current-change='handleCurrentChange' :current-page='pagination.current' :page-sizes='[10, 20, 50, 100]' :page-size='pagination.pageSize' :total='pagination.total' layout='prev,pager,next,jumper,total,sizes'></el-pagination>
			</el-row>
		</div>
		<!-- -------------------------------------------------新建班级----------------------------------------------- -->
			...
			<div style='padding: 20px 50px'>
				<el-form label-width='100px' ref='addClassForm' :model='classFrom'>
					<el-row type='flex' justify='space-between'>
						<el-col :span='11'>
							<el-form-item label='班级名称' prop='className' required :rules='{
						...
						<el-col :span='11'>
							<el-form-item label='所属年级' prop='gradge' required :rules='{
					...
					<el-row type='flex' justify='space-between'>
						<el-col :span='11'>
							<el-form-item label='班主任' prop='masterName' required :rules='{
						...
						<el-col :span='11'>
							<el-form-item label='班级描述' prop='message' required :rules='{
		...
		<el-dialog title='添加学生' size='large' ref='createStudent' v-model='dialogCreateStu' style="width:800px;padding: 50px;marginLeft:400px;">
			<div style='padding: 20px 50px'>
				<el-form label-width='100px' ref='addStuForm' :model='stuFrom'>
					<el-row type='flex' justify='space-between'>
						<el-col :span='11'>
							<el-form-item label='学生姓名' prop='studentName' required :rules='{
								      	required: true, message: "名称不能为空！"
								    }'>
